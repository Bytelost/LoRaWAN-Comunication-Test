...
static const PROGMEM u1_t NWKSKEY[16] = {0x93, 0x8F, 0xFB, 0x6F, 0xBB, 0x64, 0xE6, 0xA7, 0x00, 0xC6, 0xAB, 0xCD, 0xA1, 0xC0, 0x52, 0xA0};

// LoRaWAN AppSKey, application session key
// This should also be in big-endian (aka msb).
static const u1_t PROGMEM APPSKEY[16] = {0xDA, 0xB2, 0x1B, 0x0D, 0x6C, 0xE1, 0x1D, 0xC9, 0x89, 0xC3, 0xE4, 0x64, 0xD1, 0x0D, 0xAA, 0xA1};

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
// The library converts the address to network byte order as needed, so this should be in big-endian (aka msb) too.
static const u4_t DEVADDR = 0x260DC385; // <-- Change this address for every node!
...
void displayValues() {
  ...
  led.clear();
  led.drawString(0, 0, "LoRa esp32 - ABP");
  led.drawString(0,1,"Temp: ");
